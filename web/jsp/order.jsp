...
<body>
	...
	<form>
			...
			<div class="i-assets-content">
				...
				<div class="i-assets-body fn-clear">
					<div class="i-assets-balance-amount fn-left">
						<strong class="amount"><span style="font-size: 15px;">天狗综合商城</span></strong>
					</div>
				</div>
			</div>
			<div class="i-assets-content">
				...
				<div class="i-assets-body fn-clear">
					<div class="i-assets-balance-amount fn-left">
						<strong class="amount"><span style="font-size: 15px;"
							id="commodityName">商品费用</span></strong>
					</div>
					<div class="i-assets-balance-amount fn-left" style="clear:left">
						<strong class="amount"><span style="font-size: 15px;"
							id="commodityName">(哈哈哈)</span></strong>
					</div>
				</div>
			</div>
			<div class="i-assets-content">
				...
				<div class="i-assets-body fn-clear">
					<div class="i-assets-balance-amount fn-left">
						<strong class="amount"><span id="total">${order.total}</span></strong>元
					</div>
		...
		<div class="i-assets-container ui-bookblock-item">
			<div class="i-assets-content">
				...
				<div class="i-assets-body fn-clear">
					<div class="i-assets-balance-amount fn-left"
						style="color: #F37800;">
						<strong class="amount" style="color: #F37800;" id="totalPrice">${order.total}</strong>元
					</div>
				</div>
			</div>
		</div>
		...
		<div class='pay_buttom'>
			...
			<a href="${pageContext.request.contextPath}/jsp/native.jsp" style="background: #06C; color: #fff;">扫码支付</a>
		</div>
	</form>
</body>
</html>