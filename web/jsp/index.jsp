				...
				<div class="col-md-10">
					...
					<c:forEach var="item" items="${hList}">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							</a><%--为了避免字数过多,导致名称换行,所以可以使用函数库.对名称进行截取--%>

							<p><a href="${pageContext.request.contextPath}/product/getById?pid=${item.pid}" style='color:#666'>${fn:substring(item.pname,0,10)}...</a></p>
