...
<HTML>
	...
	<script>
<%--		${ pageContext.request.contextPath }/adminUser/delUser?uid=${user.uid}--%>
		function delUser(uid) {
			if(confirm("确定删除该用户吗?")){
				location.href = "${ pageContext.request.contextPath }/adminUser/delUser?uid="+uid+"";
			}
		}
	</script>
	<body>
						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<c:forEach var="user" items="${list}" varStatus="u">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminUser/findOne?uid=${user.uid}" value=""/>
													<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="javascript:void(0);" onclick="delUser('${user.uid}')"/>
