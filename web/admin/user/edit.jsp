...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminUser/save" method="post" >
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="telephone" value="${user.telephone}"  class="bg"/>
						</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						生日：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="date" class="form-control"  name="birthday" id="date" class="bg" value="${user.birthday}">
