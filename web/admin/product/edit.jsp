...
<HTML>
	...
	<body>
		<!--  -->
		<form  name="Form1" action="${pageContext.request.contextPath}/adminProduct/updateProduct" method="post" enctype="multipart/form-data">
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="cid">
							...
							<c:forEach var="c" items="${list}">
								<%--<option value="${c.cid}" ${c.cid==product.cid ?'selected':''}>${c.cname}</option>--%>
<%--								<c:choose>--%>
<%--									<c:when test="${c.cid eq product.cid}">--%>
